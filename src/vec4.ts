 ...
 * @category Constants
 */
export const xAxis: Vec4 = Object.freeze([1, 0, 0, 0])

/**
 * @category Constants
 */
export const yAxis: Vec4 = Object.freeze([0, 1, 0, 0])

/**
 * @category Constants
 */
export const zAxis: Vec4 = Object.freeze([0, 0, 1, 0])

/**
 * @category Constants
 */
export const wAxis: Vec4 = Object.freeze([0, 0, 0, 1])
...
export function atan(y: Vec4, x?: Vec4): Vec4 {
	if (x === undefined) {
		return [Math.atan(y[0]), Math.atan(y[1]), Math.atan(y[2]), Math.atan(y[3])]
	} else {
		return [
			Math.atan2(y[0], x[0]),
			Math.atan2(y[1], x[1]),
