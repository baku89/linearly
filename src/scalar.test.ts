...
test('ramp', () => {
	...
	expect(scalar.ramp(-36)).toEqual(0.9)
	expect(scalar.ramp(360)).toEqual(1)
	expect(scalar.ramp(-360)).toEqual(0)
	expect(scalar.ramp(-432)).toEqual(0.8)
	expect(scalar.ramp(-720)).toEqual(0)
	expect(scalar.ramp(-3924)).toEqual(0.1)
})

test('triangle', () => {
	expect(scalar.triangle(0)).toEqual(0)
	expect(scalar.triangle(90)).toEqual(0.5)
	expect(scalar.triangle(180)).toEqual(1)
	expect(scalar.triangle(288)).toEqual(0.4)
	expect(scalar.triangle(360)).toEqual(0)
	expect(scalar.triangle(504)).toEqual(0.8)
	expect(scalar.triangle(-90)).toEqual(0.5)
	expect(scalar.triangle(-504)).toEqual(0.8)
})
