...
export namespace vec2 {
	 ...
	 */
	export function clamp01(v: vec2): vec2 {
		return clamp(v, 0, 1)
	}
	 ...
	 */
	export function clamp11(v: vec2): vec2 {
		return clamp(v, -1, 1)
	}
 ...
 */
	 ...
	 */
	export function refract(I: vec2, N: vec2, eta: number): vec2 {
		const d = dot(N, I)
	 ...
	 * @returns
	 */
	export function step(edge: vec2 | number, v: vec2 | number): vec2 {
	...
	export function smoothstep(
		...
		if (typeof edge0 === 'number') edge0 = [edge0, edge0]
		if (typeof edge1 === 'number') edge1 = [edge1, edge1]
